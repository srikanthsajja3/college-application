    ...
    <View style={{ flex: 1 }}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.userName}>{profile?.full_name || 'Student Name'}</Text>
          <View style={styles.roleBadge}>
            <Text style={styles.roleText}>Verified Student</Text>
          </View>
        </View>
          ...
          <View style={styles.card}>
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>{profile?.student_roll_no || 'N/A'}</Text>
              </View>
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>
                  {profile?.classes?.department} - Year {profile?.classes?.year} ({profile?.classes?.section})
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingInfo}>
                ...
                <Text style={styles.settingSub}>Notify when attendance is marked</Text>
              </View>
              <Switch 
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingInfo}>
                ...
                <Text style={styles.settingSub}>Get notified about pending dues</Text>
              </View>
              <Switch 
                value={feeReminders} 
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#2e7d32', justifyContent: 'center', alignItems: 'center', elevation: 5, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 10 },
  ...
  card: { borderRadius: 20, padding: 5, borderWidth: 1, borderColor: '#f0f0f0', elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5 },
